...
class BehaviorCloningLossCalculator:
    ...
    def __call__(
        self,
        # policy: policies.ActorCriticPolicy,   # original
...
# ) -> policies.ActorCriticPolicy:  # original
    ...
    # assert isinstance(policy, policies.ActorCriticPolicy) # original
    assert isinstance(policy, policies.ActorCriticCnnPolicy)
    return policy
...
class BC(algo_base.DemonstrationAlgorithm):
    ...
    def __init__(
        ...
        *,
        ...
        rng: np.random.Generator,
        # policy: Optional[policies.ActorCriticPolicy] = None,  # original
        policy: Optional[policies.ActorCriticCnnPolicy] = None,
        ...
        self._policy = policy.to(utils.get_device(device))    # default 
        # self._policy = policy.to("cuda:0")    # modified
    ...
    @property
    # def policy(self) -> policies.ActorCriticPolicy:   # original
    def policy(self) -> policies.ActorCriticCnnPolicy:
        return self._policy
    ...
    def train(
        ...
        *,
        ...
        def _on_epoch_end(epoch_number: int):
            ...
            # ログの出力　# modified
            if epoch_number % log_interval == 0:
        ...
        def process_batch():
            ...
            # if batch_num % log_interval == 0: # original
            #     rollout_stats = compute_rollout_stats(self.policy, self.rng)
        ...
        for (
            ...
            obs_tensor = obs_tensor.to(self.policy.device)    # modified
